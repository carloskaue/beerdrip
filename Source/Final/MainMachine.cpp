					...
					String json = fileWifConfig.ReadLine(0);
   					...
   					if(json.length() > 10)
   					{
					    ...
					    else
					    {
							...
							{
								case 'F': {Serial.print("É igual a F\n");setState(MM_Wifi_Configuration );}break;
								case 'T': {Serial.print("É igual a T\n"); setState(MM_Wifi_Conection );}break;
